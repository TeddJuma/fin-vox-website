function Solution() {
    try {
        ...
        return (
            <section data-name="solution" ref={solutionRef} id="solution" className="section bg-green-500">
                        ...
                        <div className="scroll-reveal-content max-w-4xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                <div data-name="solution-content" className="space-y-6">
                                    <div className="card">
                                        <h3 className="text-xl font-semibold mb-4 text-black">Tap-to-Pay</h3>
                                        <p className="text-black">Instant payments without scanning or QR codes</p>
                                    </div>
                                    <div className="card">
                                ...
                                <div data-name="solution-visualization" className="flex items-center justify-center">
                                    <div className="relative w-64 h-64">
                                        <div className="absolute inset-0 bg-green-200 rounded-full opacity-10 animate-ping"></div>
                                        <div className="absolute inset-4 bg-green-800 rounded-full opacity-20"></div>
